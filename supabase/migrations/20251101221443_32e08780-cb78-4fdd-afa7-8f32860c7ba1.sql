-- Drop and recreate secure_update_academic_data without dependency on missing function
...
BEGIN
  ...
  VALUES (
    ...
    (update_data->>'target_level')::education_level,
  ...
  DO UPDATE SET
    ...
    target_level = COALESCE((update_data->>'target_level')::education_level, student_academics.target_level),
